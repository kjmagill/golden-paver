            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
                    {testimonials.map((testimonial, index) => (
                        <div key={index} className="bg-brand-bg border border-gray-200 p-8 rounded-lg shadow-lg relative transform transition-transform hover:-translate-y-2">
                            <QuoteIcon />
                            <p className="text-brand-slate-gray mb-6 relative z-10">"{testimonial.quote}"</p>
