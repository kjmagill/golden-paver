        ...
        <FadeIn direction="right">
          <div className="text-center lg:text-left">
            ...
            <a 
              ...
              className="group inline-flex items-center justify-center gap-2 sm:gap-3 bg-gradient-to-br from-brand-gold-light to-brand-gold text-brand-oxford-blue font-bold py-3 px-6 sm:px-8 rounded-lg shadow-xl text-base sm:text-lg transition-all duration-300 ease-in-out hover:brightness-110 hover:shadow-2xl hover:-translate-y-1 active:scale-95 active:translate-y-0 active:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-brand-oxford-blue focus:ring-brand-gold"
            >
