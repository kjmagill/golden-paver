...
const Hero: React.FC = () => {
  return (
    <section id="home" className="bg-brand-blue-dark text-white py-20 md:py-32">
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        <div className="text-center md:text-left">
          ...
          <a href="#contact" className="bg-brand-gold hover:bg-brand-gold-light text-brand-blue-dark font-bold py-3 px-8 rounded-lg shadow-xl transition-transform transform hover:scale-105 inline-block text-lg">
